...
public class KitchenChart extends AppCompatActivity {
    private ActivityKitchenChartBinding binding;
    ...
    public void lineChart(int month) {
        ...
        databaseReference.child("leds/led_kitchen/details").addValueEventListener(new ValueEventListener() {
            @Override
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityKitchenChartBinding.inflate(getLayoutInflater());
        View view = binding.getRoot();
        setContentView(view);
        ActionBar actionBar = getSupportActionBar();
        actionBar.setDisplayHomeAsUpEnabled(true);
        actionBar.setTitle("Kitchen led chart");
        Intent intent = getIntent();
        entryList = new ArrayList<>();
        listTimes = intent.getIntegerArrayListExtra("listMonth");
        chart = binding.bcKitchen;
