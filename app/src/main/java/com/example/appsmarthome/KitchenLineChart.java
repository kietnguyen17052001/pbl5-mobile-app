...
import com.example.appsmarthome.databinding.ActivityKitchenLineChartBinding;
...
public class KitchenLineChart extends AppCompatActivity {

    private ActivityKitchenLineChartBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityKitchenLineChartBinding.inflate(getLayoutInflater());
